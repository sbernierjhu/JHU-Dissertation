...
\vspace*{3in}                   % adjust the spacing to center it vertically
    ...
    \textit{
    This thesis is dedicated to all the scientists who have gone before me: those whose hands I have wanted to shake, and those whom I have wanted to shake.     % change to your statement
    }
\end{onehalfspacing}
\end{center}